...
const { SWA_CLI_APP_LOCATION, SWA_CLI_API_LOCATION, SWA_CLI_SERVER_TIMEOUT, SWA_CLI_OUTPUT_LOCATION, SWA_CLI_OPEN_BROWSER, SWA_CLI_APP_SSL, SWA_CLI_APP_SSL_KEY, SWA_CLI_APP_SSL_CERT, SWA_CLI_PORT, SWA_CLI_HOST, SWA_CLI_API_PORT, SWA_CLI_DEBUG, SWA_RUNTIME_CONFIG_LOCATION, SWA_RUNTIME_WORKFLOW_LOCATION, SWA_CLI_STARTUP_COMMAND, SWA_CLI_APP_BUILD_COMMAND, SWA_CLI_API_BUILD_COMMAND, SWA_CLI_LOGIN_USE_KEYCHAIN, AZURE_SUBSCRIPTION_ID, AZURE_RESOURCE_GROUP, AZURE_TENANT_ID, AZURE_CLIENT_ID, AZURE_CLIENT_SECRET, SWA_CLI_APP_NAME, SWA_CLI_DEPLOY_DRY_RUN, SWA_CLI_DEPLOY_ENV, SWA_CLI_LOGIN_CLEAR_CREDENTIALS, SWA_CLI_APP_DEVSERVER_URL, SWA_CLI_API_DEVSERVER_URL, } = (0, env_1.swaCLIEnv)();
exports.DEFAULT_CONFIG = {
    ...
    ssl: (0, env_1.useEnvVarOrUseDefault)(SWA_CLI_APP_SSL, false),
    ...
    open: (0, env_1.useEnvVarOrUseDefault)(SWA_CLI_OPEN_BROWSER, false),
    ...
    dryRun: (0, env_1.useEnvVarOrUseDefault)(SWA_CLI_DEPLOY_DRY_RUN, false),
    ...
    useKeychain: (0, env_1.useEnvVarOrUseDefault)(SWA_CLI_LOGIN_USE_KEYCHAIN, true),
    clearCredentials: (0, env_1.useEnvVarOrUseDefault)(SWA_CLI_LOGIN_CLEAR_CREDENTIALS, false),
};
